  ...
  return (
    <>
      <motion.div variants={textVariant()}>
        ...
        <h2 className={`${styles.sectionHeadText}`}>Full Catalog.</h2>
      </motion.div>
      ...
      <div className='w-full flex'>
        ...
        >
          ...
          artistic expression and is presented to inspire art lovers and collectors alike. 
          Explore the catalog to discover featured collections, creative designs, 
          and available artworks for viewing and purchase.
        </motion.p>
      </div>
...
export default SectionWrapper(Works, "catalog");
